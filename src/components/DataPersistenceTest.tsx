...
const DataPersistenceTest: React.FC = () => {
    ...
    const clearAllItems = () => {
        ...
        Alert.alert(
            'Очистить все данные?',
            'Это удалит все вещи и перезагрузит страницу.',
            [
    ...
    return (
        <View className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 m-4">
            <Text className="text-yellow-800 font-bold text-lg mb-3">
            ...
            <View className="bg-yellow-100 p-2 rounded">
                <Text className="text-yellow-800 text-sm">
                    💡 <Text className="font-bold">Инструкция:</Text> Добавьте вещь → обновите страницу (F5) → вещь должна остаться в списке.
                </Text>
            </View>
