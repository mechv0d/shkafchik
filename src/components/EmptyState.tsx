        ...
        <View className="flex-1 items-center justify-center px-8 py-16">
            <View className="card-elegant p-8 items-center max-w-sm w-full">
                ...
                <View className="flex-row mt-6 space-x-2">
                    <View className="w-2 h-2 bg-primary-200 rounded-full animate-pulse" style={{ animationDelay: '0s' }} />
                    <View className="w-2 h-2 bg-primary-300 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }} />
                    <View className="w-2 h-2 bg-primary-400 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }} />
                </View>
            </View>
        </View>
    );
